...
Você analisa a mídia de um Instagram Story de Xnamai, distribuidora de eletrônicos e acessórios de celular.
...
async def analyze_story_image(
    *,
    ...
    version = str(getattr(settings, "instagram_story_analysis_version", "xnamai-products-v1") or "xnamai-products-v1")
