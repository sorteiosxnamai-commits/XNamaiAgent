...
categories = [
    ...
    ("product_search", "tem produto marcaa?", "commerce", ["search_products"], [], True),
    ("exact_model", "quero MarcaA ChargeMax 1000", "commerce", ["search_products"], [], True),
    ("exact_color", "ChargeMax rosa", "commerce", ["search_products"], [], True),
    ("reference", "referência T120.407", "commerce", ["search_products"], [], True),
    ("ean", "ean 761160828", "commerce", ["search_products"], [], True),
    ("category", "produtos femininos", "commerce", ["search_products"], [], True),
    ("budget", "produto até 2000", "commerce", ["search_products"], [], True),
    ("compare", "compara ChargeMax e prc 200", "commerce", ["search_products"], [], True),
    ("similar", "algo parecido com ChargeMax", "commerce", ["search_products"], [], True),
    ("out_of_stock", "tem o ChargeMax preto?", "commerce", ["search_products", "check_inventory"], [], True),
    ("price", "quanto custa o ChargeMax?", "commerce", ["search_products"], [], True),
    ...
    ("audio", "quero o ChargeMax", "commerce", ["search_products"], [], True),
    ("tray_error", "tem ChargeMax?", "commerce", ["search_products"], [], True),
    ("timeout", "busca marcab Power", "commerce", ["search_products"], [], True),
...
extras = [
    ("product_search", "tem marcaq powerdock?", "commerce"),
    ("product_search", "tem marcab Power Mini?", "commerce"),
    ("exact_model", "MarcaG AudioMini", "commerce"),
    ("exact_color", "marcaa prc 200 azul", "commerce"),
